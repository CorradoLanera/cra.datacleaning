...
1. **Rivedere** 
  ...
  - le caratteristiche che devono avere oggetti coi dati da analizzare
  

2. **Imparare a** 
  - Manipolare dati di tipo testuale (espressioni regolari)
  - Manipolare i dati grezzi per estrarne informazioni analizzabili
  - Trasmutare dati grezzi in __tidy-data__
  - In generale, importare correttamente basi di dati grezzi dai corrispondenti file sorgenti (Excel/CSV).
