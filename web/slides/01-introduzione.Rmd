...
- Codifica disomogenea dei dati mancanti
- Forma dei caratteri inconsistente
- Spazi ridondanti (non facilmente visibili)
- Valori multipli su una stessa cella
- Valori spezzati su più righe
- Valori impliciti
- Numeri memorizzati come testo (con notazioni testuali)

### Nei meta-dati

- Nomi di variabili non utilizzabili
- Nomi delle variabili su più righe
- Nomi di variabili di raggruppamento su colonne unite
- Nomi di variabili di raggruppamento su righe miste ai dati
